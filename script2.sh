...
echo ""    
cd /var/www/html
wget https://github.com/viniciuscirino/ScriptSSHPrivado/blob/6b9833bbc4a03fc7c821f033f33018ade3115d0f/PaineV5.zip > /dev/null 2>&1
...
clear
wget https://github.com/viniciuscirino/ScriptSSHPrivado/blob/6b9833bbc4a03fc7c821f033f33018ade3115d0f/ssh.sql
echo "Digite a senha do PhpMyAdmin"
mysql -h localhost -u root -p ssh < ssh.sql
rm net.sql
service apache2 restart
clear
echo "CONCLUIDO"