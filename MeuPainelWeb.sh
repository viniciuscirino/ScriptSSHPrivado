...
#
rm /root/MeuPainelWeb.sh > /dev/null 2>&1
rm $HOME/MeuPainelWeb.sh > /dev/null 2>&1
rm /root/MeuPainelWeb.sh > /dev/null 2>&1
rm $HOME/MeuPainelWeb.sh > /dev/null 2>&1
...
rm $HOME/MeuPainelWeb.sh > /dev/null 2>&1
rm /root/PaineV5.zip > /dev/null 2>&1

echo -e "\E[44;1;37m    INSTALAR O PAINEL SSH/NEW GenerationSSH    \E[0m" 
echo ""
...
cd /var/www/html
#link para o painelweb
wget https://github.com/viniciuscirino/ScriptSSHPrivado/blob/fdd8aa1ed760c7dd40ccc8dd3e77a21b60a8b7e9/PaineV5.zip > /dev/null 2>&1
sleep 1
unzip PaineV5.zip > /dev/null 2>&1
rm -rf PaineV5.zip index.html > /dev/null 2>&1
service apache2 restart
sleep 1
...
sleep 1
cd
#link para o script sql do painel
wget https://github.com/viniciuscirino/ScriptSSHPrivado/blob/21974ff4d4aae3f880315ccf6ff4701101d37fa7/ssh.sql > /dev/null 2>&1
sleep 1
